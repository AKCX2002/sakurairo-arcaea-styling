...
- 修复后真实文章 ID 796 正常地址渲染 3 个 KaTeX 公式、0 个公式错误；首页进入“嵌入式专题”的 timeOrigin 不变，确认真实 PJAX，浏览器未记录页面错误。主题更新服务无更新检查成功。GitHub Integration Check 已通过补丁应用、含百分号评论模板回归及技能完整安装检查。
